...
export default function Modal({isOpen, setClose}) {
  ...
  return (
      ...
      <div className="rounded-lg grow max-w-2xl bg-white p-4 shadow-lg">
        ...
        <div className="flex justify-end gap-4">
          <button onClick={()=> setClose(false)}  className="rounded-md bg-gray-300 px-6 py-2 font-semibold hover:bg-gray-400/80 active:bg-gray-400/60">
            Cancel
          </button>
